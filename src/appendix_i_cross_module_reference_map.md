...
| Business ROI (Topic 9) | All Modules (1-26) | Each module's Topic 9 provides domain-specific ROI framework; Appendix J (ROI Calculator Templates) |

---

## I.4 Business ROI Cross-Module Reference Map (Topic 9)

> Every module now includes a **Topic 9: Business ROI** section that provides a domain-specific ROI framework. This section maps how the 26 Topic 9s interconnect, forming a comprehensive ROI measurement architecture. All Topic 9 ROI frameworks have corresponding calculator templates in **Appendix J: ROI Calculator Templates**.
...
| **ALL Topic 9s** ↔ **Appendix J** (ROI Calculator Templates) | Calculator templates for each module's ROI framework | Appendix J provides ready-to-use spreadsheet templates, formulas, and worked examples for every module's Topic 9 ROI calculations |
...
|--------|--------------|-----------------|--------------------------|
| **1: Operating Model** | Operating Model ROI | Cost per entity, PEPM margin impact, model switch savings | M26 T9, Appendix J |
| **2: Worker Lifecycle** | Worker Lifecycle ROI | Onboarding cost reduction, time-to-productivity, offboarding savings | M13 T9, M22 T9, Appendix J |
| **3: Payroll Engine** | Payroll ROI | Error rate reduction value, processing time savings, penalty avoidance | M5 T9, M15 T9, Appendix J |
| **4: Treasury/Payments** | Treasury ROI | FX savings, payment timing optimization, float revenue | M15 T9, M16 T9, Appendix J |
| **5: Compliance** | Compliance ROI | Penalty avoidance, audit cost reduction, filing automation savings | M5 T10, M6 T9, Appendix J |
| **6: EOR/COR Risk** | Risk Management ROI | Misclassification avoidance, PE risk mitigation value, insurance savings | M5 T9, M20 T9, Appendix J |
| **7: Data Platform** | Data Platform ROI | Query cost reduction, data freshness improvement, self-serve adoption value | M8 T9, M12 T9, Appendix J |
| **8: MDM** | MDM ROI | Data quality improvement value, deduplication savings, reconciliation reduction | M7 T9, M10 T9, Appendix J |
| **9: Applied ML** | ML/AI ROI | Model accuracy value, automation savings, prediction-driven revenue | M24 T9, M7 T9, Appendix J |
| **10: Reliability/Security** | Reliability ROI | Downtime cost avoidance, incident reduction value, compliance audit savings | M7 T9, M12 T9, Appendix J |
| **11: Product Management** | Product ROI | Feature adoption revenue, roadmap prioritization value, NPS-driven retention | M12 T9, M13 T9, Appendix J |
| **12: Product Engineering** | Engineering ROI | Deployment frequency value, MTTR reduction, tech debt payoff | M11 T9, M10 T9, Appendix J |
| **13: Client Success** | Client Success ROI | NRR improvement, churn reduction value, expansion revenue attribution | M17 T9, M14 T9, Appendix J |
| **14: Customer Support** | Support ROI | Ticket deflection savings, resolution time value, escalation reduction | M13 T9, M9 T9, Appendix J |
| **15: Finance & FP&A** | Finance Partnership ROI | Forecast accuracy value, close cycle reduction, budget variance improvement | M16 T9, M4 T9, Appendix J |
| **16: Advanced Finance** | Advanced Finance ROI | LTV/CAC optimization value, scenario modeling accuracy, hedging savings | M15 T9, M18 T9, Appendix J |
| **17: Sales** | Sales Analytics ROI | Pipeline conversion improvement, Deal Desk cycle reduction, win rate lift | M19 T9, M13 T9, Appendix J |
| **18: TAM/Market Sizing** | Market Sizing ROI | Market entry decision value, sizing accuracy improvement, opportunity cost avoidance | M17 T9, M23 T9, Appendix J |
| **19: Marketing** | Marketing Analytics ROI | Attribution accuracy value, MQL quality improvement, CAC reduction | M17 T9, M18 T9, Appendix J |
| **20: Partners/Vendors** | Partner Ecosystem ROI | Partner performance improvement, vendor consolidation savings, SLA compliance value | M6 T9, M23 T9, Appendix J |
| **21: Competitive Intelligence** | Competitive Intel ROI | Win rate improvement from battlecards, feature gap closure value, positioning ROI | M17 T9, M11 T9, Appendix J |
| **22: People Analytics** | People Analytics ROI | Attrition reduction savings, engagement improvement value, workforce planning accuracy | M25 T9, M2 T9, Appendix J |
| **23: Country Launch** | Country Launch ROI | Launch cost optimization, time-to-revenue improvement, market entry ROI | M18 T9, M20 T9, Appendix J |
| **24: AI/ML Strategy** | AI Strategy ROI | AI portfolio value, governance cost avoidance, build-vs-buy optimization | M9 T9, M7 T9, Appendix J |
| **25: Change Management** | Change Management ROI | Adoption rate improvement value, resistance cost avoidance, training ROI | M22 T9, M24 T9, Appendix J |
| **26: Analytics Leader Execution** | Function-Level ROI | Aggregated analytics function ROI, quick-win value, stakeholder confidence improvement | All T9s, Appendix J |
...
Individual Module Topic 9s (M1-M25)
    ...
    | using Appendix J calculator templates
    |
    v
...
*End of Appendix I: Cross-Module Reference Map*

*This appendix provides navigation across the 26-module Global Payroll / EOR / COR Operations Domain Book. For Business ROI calculator templates referenced in Section I.4, see Appendix J. For detailed content, worked examples, exercises, and SQL queries, refer to the individual module files.*
